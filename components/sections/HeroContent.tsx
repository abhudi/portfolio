...
export default function HeroContent() {
  ...
  return (
    ...
    >
      ...
      Enthusiastic and meticulous full-stack developer with a talent for designing aesthetically pleasing and user-friendly web applications. 
      </div>
      ...
      Where innovation harmoniously blends with practicality.
      </div>
