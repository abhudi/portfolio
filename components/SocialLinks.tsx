...
const socialLinks = [
  {
    id: 1,
    title: "Abhishek Deshmukh Github Profile",
    link: "https://github.com/abhudi",
    svg: (
      <svg
  ...
  {
    id: 2,
    title: "Abhishek Deshmukh LinkedIn Profile",
    link: "https://www.linkedin.com/in/abhishek-deshmukh-b0b618211/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 3,
    title: "Abhishek Deshmukh dev.to",
    link: "https://dev.to/abhudi",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
